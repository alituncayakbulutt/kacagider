...
function css(){
  ...
  @media(max-width:900px){
    .kg-approved-topbar .kg-topbar-actions{display:grid!important;grid-template-columns:128px 42px!important;grid-template-rows:42px 42px!important;grid-template-areas:"sell sell" "menu theme"!important;gap:8px!important;width:178px!important;min-width:0!important;align-items:center!important;justify-items:stretch!important;flex-shrink:0!important}
    .kg-approved-topbar .kg-v3-action.listings{display:none!important}
    .kg-approved-topbar .kg-v3-action.sell{grid-area:sell!important;display:inline-flex!important;width:auto!important;height:42px!important;padding:0 10px!important;font-size:11px!important;box-sizing:border-box!important}
    .kg-approved-topbar .kg-mobile-nav-toggle{grid-area:menu!important;display:flex!important;align-items:center!important;justify-content:center!important;width:42px!important;height:42px!important;padding:0!important;margin:0!important}
    .kg-approved-topbar .kg-theme-btn{grid-area:theme!important;display:flex!important;align-items:center!important;justify-content:center!important;width:42px!important;height:42px!important;padding:0!important;margin:0!important;font-size:21px!important;line-height:1!important;overflow:visible!important}
    .kg-v3-shell{height:620px!important}.kg-v3-visual{height:225px!important}.kg-v3-card{height:220px!important}
  }
  @media(max-width:600px){
    .kg-approved-topbar .kg-v3-action.sell{width:100%!important}
    .kg-v3-shell{height:640px!important}.kg-v3-slide{padding:30px 24px 52px!important}.kg-v3-visual{height:235px!important}.kg-v3-card{width:280px!important;height:225px!important}
  }
  `;
