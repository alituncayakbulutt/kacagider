...
function installStyle(){
  var old=document.getElementById("kgNavV4Style");
  if(old) old.remove();
  ...
  .kg-account-direct-overlay{position:fixed;inset:0;z-index:1000005;background:rgba(7,20,38,.76);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);display:flex;align-items:center;justify-content:center;padding:22px;overflow-y:auto;box-sizing:border-box}
  .kg-account-direct-card{width:min(448px,100%);background:#fff;color:#101828;border:1px solid rgba(255,255,255,.8);border-radius:22px;padding:28px;box-shadow:0 32px 90px rgba(2,6,23,.38);position:relative;box-sizing:border-box;overflow:hidden}
  .kg-account-direct-card:before{content:"";position:absolute;left:0;right:0;top:0;height:5px;background:linear-gradient(90deg,#16a34a,#22c55e)}
  .kg-account-direct-card h2{margin:0 46px 7px 0;font-size:27px;line-height:1.15;letter-spacing:-.55px;color:#0b1628;font-weight:950}
  .kg-account-direct-card p{margin:0 0 20px;color:#667085;font-size:13px;line-height:1.55}
  .kg-account-direct-close{position:absolute;right:16px;top:16px;width:38px;height:38px;border:1px solid #e7ebf0;border-radius:11px;background:#f8fafc;color:#344054;font-size:22px;line-height:1;cursor:pointer;transition:.18s}
  .kg-account-direct-close:hover{background:#eef2f6;color:#101828}
  .kg-account-direct-tabs{display:grid!important;grid-template-columns:1fr 1fr!important;gap:4px!important;background:#f1f5f3!important;border:1px solid #e2e9e5!important;border-radius:13px!important;padding:4px!important;margin:0 0 18px!important}
  .kg-account-direct-tab{appearance:none!important;border:0!important;background:transparent!important;border-radius:9px!important;min-height:42px!important;padding:0 12px!important;font:inherit!important;font-size:13px!important;font-weight:900!important;color:#667085!important;cursor:pointer!important;transition:.18s!important}
  .kg-account-direct-tab.active{background:#0b1628!important;color:#fff!important;box-shadow:0 3px 9px rgba(11,22,40,.16)!important}
  .kg-account-direct-tab:not(.active):hover{background:#fff!important;color:#087a37!important}
  .kg-account-direct-google{width:100%;min-height:50px;border:1px solid #d0d5dd;border-radius:12px;background:#fff;color:#1d2939;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;box-shadow:0 1px 2px rgba(16,24,40,.03);transition:.18s}
  .kg-account-direct-google:hover{border-color:#98a2b3;background:#f9fafb}
  .kg-account-direct-google b{width:27px;height:27px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;border:1px solid #e5e7eb;color:#4285f4;background:#fff;font-family:Arial,sans-serif;font-size:16px}
  .kg-account-direct-divider{display:flex;align-items:center;gap:12px;color:#98a2b3;font-size:11px;font-weight:800;margin:17px 0}.kg-account-direct-divider:before,.kg-account-direct-divider:after{content:"";height:1px;background:#e5e7eb;flex:1}
  .kg-account-direct-field{display:grid;gap:7px;margin-bottom:14px}
  .kg-account-direct-field label{font-size:12px;font-weight:900;color:#344054}
  .kg-account-direct-field input{width:100%;min-height:49px;border:1px solid #d0d5dd;border-radius:12px;padding:11px 13px;font:inherit;font-size:15px;box-sizing:border-box;background:#fff;color:#101828;outline:none;transition:border-color .18s,box-shadow .18s}
  .kg-account-direct-field input:focus{border-color:#22a857;box-shadow:0 0 0 4px rgba(34,168,87,.10)}
  .kg-account-direct-field small{font-size:11px;color:#667085;line-height:1.4}
  .kg-account-direct-submit{width:100%;min-height:50px;border:0;border-radius:12px;background:#16a34a;color:#fff;font-size:14px;font-weight:950;cursor:pointer;box-shadow:0 8px 18px rgba(22,163,74,.20);transition:.18s}
  .kg-account-direct-submit:hover{background:#128a3f;transform:translateY(-1px)}
  .kg-account-direct-submit:disabled,.kg-account-direct-google:disabled{opacity:.6;cursor:wait;transform:none}
  .kg-account-direct-note{display:none;margin:0 0 14px;padding:11px 12px;border-radius:11px;background:#f0fdf4;border:1px solid #bbf7d0;color:#166534;font-size:12px;line-height:1.45}.kg-account-direct-note.show{display:block}.kg-account-direct-note.error{background:#fff1f2;border-color:#fecdd3;color:#b42318}
  .kg-account-direct-forgot{display:inline-flex;align-items:center;min-height:38px;margin-top:5px;border:0;background:transparent;padding:4px 0;color:#087a37;font-size:12px;font-weight:900;cursor:pointer}
  .kg-account-direct-forgot:hover{text-decoration:underline}
  ...
  @media(max-width:600px){.kg-approved-topbar .kg-v4-action.sell{width:100%!important}.kg-v4-shell{height:640px!important}.kg-v4-slide{padding:30px 24px 52px!important}.kg-v4-visual{height:235px!important}.kg-v4-card{width:280px!important;height:225px!important}.kg-account-direct-overlay{align-items:flex-start;padding:max(12px,env(safe-area-inset-top)) 10px max(12px,env(safe-area-inset-bottom))}.kg-account-direct-card{width:100%;margin:auto 0;padding:23px 17px 18px;border-radius:18px;max-height:calc(100dvh - 20px);overflow-y:auto}.kg-account-direct-card h2{font-size:24px}.kg-account-direct-card p{margin-bottom:16px}.kg-account-direct-tabs{margin-bottom:15px!important}.kg-account-direct-field{margin-bottom:12px}.kg-account-direct-field input,.kg-account-direct-submit,.kg-account-direct-google{min-height:50px}.kg-account-direct-close{right:12px;top:12px}}
  `;
