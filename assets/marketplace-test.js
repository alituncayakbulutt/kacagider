(function(){
  ...
  load('/assets/marketplace-core.js?v=20260914-card2','kgMarketplaceCore')
    .then(function(){return load('/assets/marketplace-sell-options.js?v=20260914-card2','kgMarketplaceSellOptions');})
