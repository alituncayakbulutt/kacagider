...
html[data-theme="dark"] .kg-device-score-card{background:#132233!important;border-color:#315541!important}html[data-theme="dark"] .kg-ds-head h3,html[data-theme="dark"] .kg-ds-row b{color:#edf3fb!important}html[data-theme="dark"] .kg-ds-head p,html[data-theme="dark"] .kg-ds-row label,html[data-theme="dark"] .kg-ds-reasons ul{color:#b7c3d5!important}html[data-theme="dark"] .kg-ds-reasons{border-color:#2d3c52!important}';
  ...
  function ensureModelDemand(){
    if(window.__KG_MODEL_DEMAND__||document.querySelector('script[data-kg-model-demand]'))return;
    var script=document.createElement('script');
    script.src='/assets/model-demand.js';
    script.defer=true;
    script.dataset.kgModelDemand='1';
    document.head.appendChild(script);
  }
  ...
  function ensurePriceHistory(){
    if(window.__KG_PRICE_HISTORY__||document.querySelector('script[data-kg-price-history]'))return;
    var script=document.createElement('script');
    script.src='/assets/price-history.js';
    script.defer=true;
    script.dataset.kgPriceHistory='1';
    document.head.appendChild(script);
  }
  ...
  function ready(){
    ensureStyle();ensureCard();ensureExpertise();ensureModelDemand();ensureDealerTrustOffers();ensurePriceHistory();
