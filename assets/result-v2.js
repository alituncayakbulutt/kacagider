(function(){
  ...
  function ensureAccountNav(){
    ...
    loadFixedScript('/assets/account-session-nav.js?v=20260904-account-only-fix2','kgPhase3AccountNav').then(function(){setTimeout(enhanceAccountButton,500);setTimeout(enhanceAccountButton,1400);}).catch(function(){});
  }
