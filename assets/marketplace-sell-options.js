...
load('/assets/tr-location-selects.js?v=20260906-p1','kgTrLocationSelects')
  .then(function(){return load('/assets/marketplace-sell-options-modal.js?v=20260907-store1','kgDealerSellPhase1');})
  .then(function(){return load('/assets/marketplace-damage-guard.js?v=20260907-store1','kgDealerDamageGuard');})
  .then(function(){return load('/assets/marketplace-dealer-backend.js?v=20260907-store1','kgDealerBackend');})
