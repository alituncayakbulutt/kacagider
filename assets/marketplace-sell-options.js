...
load('/assets/tr-location-selects.js?v=20260906-p1','kgTrLocationSelects')
  .then(function(){return load('/assets/marketplace-sell-options-modal.js?v=20260914-card2','kgDealerSellPhase1');})
  .then(function(){return load('/assets/marketplace-damage-guard.js?v=20260914-card2','kgDealerDamageGuard');})
  .then(function(){return load('/assets/marketplace-dealer-backend.js?v=20260914-card2','kgDealerBackend');})
  .then(function(){return load('/assets/marketplace-dealer-submit.js?v=20260914-card2','kgDealerSubmit');})
  .then(function(){return load('/assets/marketplace-sell-options-ui.js?v=20260914-card2','kgSellOptionsUiPhase1');})
