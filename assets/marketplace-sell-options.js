...
load('/assets/marketplace-sell-options-modal.js?v=20260905-phase1','kgDealerSellPhase1').then(function(){return load('/assets/marketplace-sell-options-ui.js?v=20260905-phase1','kgSellOptionsUiPhase1');}).catch(function(error){console.warn('KaçaGider satış seçenekleri yüklenemedi:',error);});
})();